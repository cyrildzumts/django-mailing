...
SETTINGS_MAIL_CAMPAIGN_MAPPING = "MAIL_CAMPAIGN_MAPPING"
...
MAIL_CAMPAIGN_STANDARD = 0
MAIL_CAMPAIGN_MULTIPLE_PRODUCT = 1
MAIL_CAMPAIGN_SALES_PRODUCT = 2

MAIL_CAMPAIGN_TYPES = (
    (MAIL_CAMPAIGN_STANDARD, 'Standard'),
    (MAIL_CAMPAIGN_MULTIPLE_PRODUCT, 'Products'),
    (MAIL_CAMPAIGN_SALES_PRODUCT, 'Sales')
)
